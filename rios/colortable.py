...
def loadBuiltinRamps():
    ...
    generated by TuiView's colorbrewer2py.py
    """
    ramp = {}
...
def genTable(numEntries, colortype):
    """
    ...
    if colortype == RANDOM_NAME:
        ...
        for idx, code in enumerate(('red', 'green', 'blue')):
            ...
            # return as 8 bit int
            ct[idx] = yinterp.astype(numpy.uint8)
...
def setTable(imgFile, colorTable, bandNumber=1):
    ...
    The colorTable is given as an array of shape (4, numRows)
    where numRows is the size of the color table. The order of indices
