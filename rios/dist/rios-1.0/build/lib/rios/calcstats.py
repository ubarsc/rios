...
import cuiprogress
from exceptions import ProcessCancelledError
...
def addStatistics(ds,progress,ignore=None):
    ...
    for bandnum in range(ds.RasterCount):
        ...
        # correctly in Imagine. Note that this is conditional on a patch to GDAL
        # which has not yet happened, to enable this mechanism. 
